...
const generateMessageID = () => 'HISOKA-' + (0, crypto_1.randomBytes)(6).toString('hex').toUpperCase();
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/Dwi-Merajah/Hisoka-Baileys/master/src/Defaults/baileys-version.json';
    try {
